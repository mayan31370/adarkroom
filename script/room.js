...
var Room = {
	...
	_FIRE_COOL_DELAY: 5 * 60 * 100, // time after a stoke before the fire cools
	_ROOM_WARM_DELAY: 30 * 100, // time between room temperature updates
	_BUILDER_STATE_DELAY: 0.5 * 60 * 100, // time between builder state updates
	_STOKE_COOLDOWN: 10, // cooldown to stoke the fire
	_NEED_WOOD_DELAY: 15 * 100, // from when the stranger shows up, to when you need wood
